...
class NewsSpider(scrapy.Spider):
    ...
    try:
        ...
        detik_last = ("SELECT berita_qdate FROM berita WHERE berita_qdate IN (SELECT max(berita_qdate) FROM berita where berita_source = 'www.detik.com' AND berita_topik_id = 2)")
        ...
        kompas_last = ("SELECT berita_qdate FROM berita WHERE berita_qdate IN (SELECT max(berita_qdate) FROM berita where berita_source = 'www.kompas.com' AND berita_topik_id = 2)")
        ...
        tribun_last = ("SELECT berita_qdate FROM berita WHERE berita_qdate IN (SELECT max(berita_qdate) FROM berita where berita_source = 'www.tribunnews.com' AND berita_topik_id = 2)")
        ...
        tempo_last = ("SELECT berita_qdate FROM berita WHERE berita_qdate IN (SELECT max(berita_qdate) FROM berita where berita_source = 'www.tempo.co' AND berita_topik_id = 2)")
        ...
        #topik_id = 2 (ekonomi)
        querydetik = ("SELECT nama_keyword FROM keyword WHERE source='detik' AND topik_id=2")
        querytribun = ("SELECT nama_keyword FROM keyword WHERE source='tribun' AND topik_id=2")
        querykompas = ("SELECT nama_keyword FROM keyword WHERE source='kompas' AND topik_id=2")
        querytempo = ("SELECT nama_keyword FROM keyword WHERE source='tempo' AND topik_id=2")
    ...
    berita = []
    visited = []
    skipped_subdomain = ["travel", "20", "inet",
                         "hot", "sport", "oto", "health", "food", "foto", "wolipop","otomotif","internasional"]
    tempo_skip_subdomain = ["seleb", "dunia", "otomotif", "travel", "sport", "difabel", "tekno", "www", "kolom", "gaya", "fokus", "bola"]
