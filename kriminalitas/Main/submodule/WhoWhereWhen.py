...
class WhoWhereWhen:
    def __init__(self) -> None:
        ...
        try:
            ...
            # cursor.execute("SELECT ID, berita_date, berita_desc FROM berita where berita_topik_id = 5 ")
    ...
    def get3W(self):
        try:
            ...
            # all_tagged = joblib.load('D:/Repository/PetaKabar/whowherewhen/complete_tagged_kriminalitas.pkl')
