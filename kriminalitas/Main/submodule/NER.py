...
class NER:
    def __init__(self) -> None:
        ...
        self.listDaerah = joblib.load('D:/Repository/PetaKabar/kriminalitas/Main/model/Where/listProvKabKec.pkl')
        self.listProvinsi = joblib.load('D:/Repository/PetaKabar/kriminalitas/Main/model/Where/provinsi.pkl')
        self.listKabupaten = joblib.load('D:/Repository/PetaKabar/kriminalitas/Main/model/Where/kabupaten.pkl')
        self.listKecamatan = joblib.load('D:/Repository/PetaKabar/kriminalitas/Main/model/Where/kecamatan.pkl')
        self.loaded_model = load('D:/Repository/PetaKabar/kriminalitas/Main/model/NER_Kec_Ben_Krim_Kese_Eko/output/model-last')
        ...
        try:
            ...
            cursor = cnx.cursor()
            cursor.execute("SELECT ID, berita_date, berita_desc FROM berita where berita_topik_id = 5 AND class_classification is null")
