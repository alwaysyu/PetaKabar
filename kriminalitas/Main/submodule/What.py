...
class What:
    def __init__(self) -> None:
        # Bagian LDA
        self.total_topics = 6
        self.number_words = 20
        self.lda_model = models.ldamodel.LdaModel.load(datapath('D:/Repository/PetaKabar/models/lda_model_kriminalitas/lda_model')) # Ambil Model LDA sesuai dengan topik
        ...
        try:
            ...
            # cursor.execute("SELECT ID, berita_desc, berita_title FROM berita where berita_topik_id = 5 ") # adjust
