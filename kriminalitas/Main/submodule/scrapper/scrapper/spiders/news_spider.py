...
class NewsSpider(scrapy.Spider):
    ...
    #     # "https://www.detik.com/search/searchall?query=pembunuhan&sortby=time&sorttime=2&fromdatex=15/06/2022&todatex=15/07/2022",
    #     # "https://www.detik.com/search/searchall?query=pencurian&sortby=time&sorttime=2&fromdatex=15/06/2022&todatex=15/07/2022",
    #     # "https://www.detik.com/search/searchall?query=pemerkosaan&sortby=time&sorttime=2&fromdatex=15/06/2022&todatex=15/07/2022",
    #     # "https://www.detik.com/search/searchall?query=perampokan&sortby=time&sorttime=2&fromdatex=15/06/2022&todatex=15/07/2022",
    #     # "https://www.detik.com/search/searchall?query=curanmor&sortby=time&sorttime=2&fromdatex=15/06/2022&todatex=15/07/2022"
    ...
    try:
        ...
        detik_last = ("SELECT berita_qdate FROM berita WHERE berita_qdate IN (SELECT max(berita_qdate) FROM berita where berita_source = 'www.detik.com' AND berita_topik_id = 5)")
        ...
        kompas_last = ("SELECT berita_qdate FROM berita WHERE berita_qdate IN (SELECT max(berita_qdate) FROM berita where berita_source = 'www.kompas.com' AND berita_topik_id = 5)")
        ...
        tribun_last = ("SELECT berita_qdate FROM berita WHERE berita_qdate IN (SELECT max(berita_qdate) FROM berita where berita_source = 'www.tribunnews.com' AND berita_topik_id = 5)")
        ...
        tempo_last = ("SELECT berita_qdate FROM berita WHERE berita_qdate IN (SELECT max(berita_qdate) FROM berita where berita_source = 'www.tempo.co' AND berita_topik_id = 5)")
        ...
        #topik_id = 5 (kriminalitas)
        querydetik = ("SELECT nama_keyword FROM keyword WHERE source='detik' AND topik_id=5")
        querytribun = ("SELECT nama_keyword FROM keyword WHERE source='tribun' AND topik_id=5")
        querykompas = ("SELECT nama_keyword FROM keyword WHERE source='kompas' AND topik_id=5")
        querytempo = ("SELECT nama_keyword FROM keyword WHERE source='tempo' AND topik_id=5")
