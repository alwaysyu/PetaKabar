...
class NewsSpider(scrapy.Spider):
    ...
    try:
        ...
        detik_last = ("SELECT berita_qdate FROM berita WHERE berita_qdate IN (SELECT max(berita_qdate) FROM berita where berita_source = 'www.detik.com' AND berita_topik_id = 6)")
        ...
        kompas_last = ("SELECT berita_qdate FROM berita WHERE berita_qdate IN (SELECT max(berita_qdate) FROM berita where berita_source = 'www.kompas.com' AND berita_topik_id = 6)")
        ...
        tribun_last = ("SELECT berita_qdate FROM berita WHERE berita_qdate IN (SELECT max(berita_qdate) FROM berita where berita_source = 'www.tribunnews.com' AND berita_topik_id = 6)")
        ...
        tempo_last = ("SELECT berita_qdate FROM berita WHERE berita_qdate IN (SELECT max(berita_qdate) FROM berita where berita_source = 'www.tempo.co' AND berita_topik_id = 6)")
        ...
        #topik_id = 6 (kecelakaan)
        querydetik = ("SELECT nama_keyword FROM keyword WHERE source='detik' AND topik_id=6")
        querytribun = ("SELECT nama_keyword FROM keyword WHERE source='tribun' AND topik_id=6")
        querykompas = ("SELECT nama_keyword FROM keyword WHERE source='kompas' AND topik_id=6")
        querytempo = ("SELECT nama_keyword FROM keyword WHERE source='tempo' AND topik_id=6")
    ...
    skipped_subdomain = ["travel", "20", "finance", "inet",
                         "hot", "oto", "health", "food", "foto", "wolipop","otomotif","internasional","biz"]
    tempo_skip_subdomain = ["seleb", "dunia", "otomotif", "travel", "bisnis", "difabel", "tekno", "www", "kolom", "gaya", "fokus","en","cantik"]
    skipped_parsed_link_path = ["seleb", "internasional", "otomotif"]
                ...
                for detailarticle in article.css("li.ptb15"):
                    ...
                    for articledate in detailarticle.css("div.grey"):
                        ...
                        if ("lalu" not in article_split):
                            ...
                            #cek apa artikel lebih baru dari yang ada di database
                            if(self.tribun_lastdate > tgl2):
                                start_url = NewsSpider.start_urls.pop()
                                yield Request(start_url, self.parse, meta=meta)
                            #cek apakah tgl artikel masuk dalam jangka 1 bulan dari hari ini
