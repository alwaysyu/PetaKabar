...
class Severity:
    def __init__(self) -> None:
        ...
        self.ct.set_model_file('D:/Repository/PetaKabar/kesehatan/main/model/TagIndo/all_indo_man_tag_corpus_model.crf.tagger')
    ...
    def getKeparahanVelue(self):
        try:
            ...
            for i in range(0, len(self.newsscrapped)):
                ...
                """
                death= self.getKeparahan(berita, True, ['meninggal','mati','tewas','meregang nyawa','menewaskan','merenggut','jenazah','Jenazah','Merenggut','Meninggal','Mati','Tewas','Meregang','Menewaskan']) #kematian #terseret #nyawa #,'jiwa' Merenggut
                injury= self.getKeparahan(berita, True, ['Sakit','sakit','terjangkit','Terjangkit','kritis','kasus','Kasus','dirawat','Kritis','perawatan','Perawatan', 'positif', 'Positif', 'tertular', 'penderita', 'divonis', 'berobat'])
                ...
                self.save_to_mysql(idberita, death, injury)
            return "success"
        except:
            return "error"
    ...
    def save_to_mysql(self, idberita, death, injury):
        try:
            ...
            data_news = (death, injury, idberita)
