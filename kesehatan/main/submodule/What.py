...
class What:
    def __init__(self) -> None:
        ...
        try:
            ...
            cursor = cnx.cursor()
            cursor.execute("SELECT ID, berita_desc, berita_title FROM berita where berita_topik_id = 4  AND class_classification is null") # adjust
            # cursor.execute("SELECT ID, berita_desc, berita_title FROM berita where berita_topik_id = 4 ") # adjust
