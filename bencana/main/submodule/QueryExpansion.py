...
class QueryExpansion:
    def __init__(self) -> None:
        ...
        self.document_text = joblib.load('D:/Repository/PetaKabar/bencana/main/dataset/qe/desc_text_train_new.pkl')
        ...
        self.tfidf_vectorizer = joblib.load('D:/Repository/PetaKabar/bencana/main/dataset/qe/vectorizer_new.pkl')
        self.tfidf_matrix = joblib.load('D:/Repository/PetaKabar/bencana/main/dataset/qe/tfidf_train_new.pkl')
        self.df_total = pd.read_csv('D:/Repository/PetaKabar/bencana/main/dataset/qe/df_total_new.csv')
        

        # df_bow_what = pd.read_csv('dataset/qe/bow_what.csv')
        df_bow_what = pd.read_csv('D:/Repository/PetaKabar/bencana/main/dataset/qe/bow_what.csv')
