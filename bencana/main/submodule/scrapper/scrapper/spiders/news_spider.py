...
class NewsSpider(scrapy.Spider):
    ...
    # start_urls = [
    #     "https://www.detik.com/search/searchall?query=tanah%20longsor&sortby=time&sorttime=2&fromdatex=15/06/2021&todatex=15/07/2022",
    #     "https://www.detik.com/search/searchall?query=gempa%20bumi&sortby=time&sorttime=2&fromdatex=15/06/2021&todatex=15/07/2022",
    #     "https://www.detik.com/search/searchall?query=kebakaran&sortby=time&sorttime=2&fromdatex=15/06/2021&todatex=15/07/2022",
    #     "https://www.detik.com/search/searchall?query=banjir&sortby=time&sorttime=2&fromdatex=15/06/2021&todatex=15/07/2022",
    #     "https://www.detik.com/search/searchall?query=kekeringan&sortby=time&sorttime=2&fromdatex=15/06/2021&todatex=15/07/2022",
    #     "https://www.detik.com/search/searchall?query=angin%20kencang&sortby=time&sorttime=2&fromdatex=15/06/2021&todatex=15/07/2022",
    #     "https://www.detik.com/search/searchall?query=puting%20beliung&sortby=time&sorttime=2&fromdatex=15/06/2021&todatex=15/07/2022",
    #     "https://www.detik.com/search/searchall?query=pergerakan%20tanah&sortby=time&sorttime=2&fromdatex=15/06/2021&todatex=15/07/2022",
    #     "https://www.detik.com/search/searchall?query=erosi&sortby=time&sorttime=2&fromdatex=15/06/2021&todatex=15/07/2022",
    #     "https://www.detik.com/search/searchall?query=abrasi&sortby=time&sorttime=2&fromdatex=15/06/2021&todatex=15/07/2022"
    # ]
    detik_url = []
    tribun_url = []
    kompas_url = []
    ...
    try:
        ...
        detik_last = ("SELECT berita_qdate FROM berita WHERE berita_qdate IN (SELECT max(berita_qdate) FROM berita where berita_source = 'www.detik.com' AND berita_topik_id = 1)")
        ...
        kompas_last = ("SELECT berita_qdate FROM berita WHERE berita_qdate IN (SELECT max(berita_qdate) FROM berita where berita_source = 'www.kompas.com' AND berita_topik_id = 1)")
        ...
        tribun_last = ("SELECT berita_qdate FROM berita WHERE berita_qdate IN (SELECT max(berita_qdate) FROM berita where berita_source = 'www.tribunnews.com' AND berita_topik_id = 1)")
        ...
        tempo_last = ("SELECT berita_qdate FROM berita WHERE berita_qdate IN (SELECT max(berita_qdate) FROM berita where berita_source = 'www.tempo.co' AND berita_topik_id = 1)")
        ...
        #topik_id = 2 (ekonomi)
        querydetik = ("SELECT nama_keyword FROM keyword WHERE source='detik' AND topik_id=1")
        querytribun = ("SELECT nama_keyword FROM keyword WHERE source='tribun' AND topik_id=1")
        querykompas = ("SELECT nama_keyword FROM keyword WHERE source='kompas' AND topik_id=1")
        querytempo = ("SELECT nama_keyword FROM keyword WHERE source='tempo' AND topik_id=1")
    ...
    skipped_subdomain = ["travel", "20", "finance", "inet",
                         "hot", "sport", "oto", "health", "food", "foto", "wolipop","otomotif","internasional"]
                                    ...
                                    ("seleb" not in parsed_link.path) and \
                                        ("superskor" not in parsed_link.path) and \
                                            ("otomotif" not in parsed_link.path) and \
                                                ("techno" not in parsed_link.path) and \
                                                ("nasional" not in parsed_link.path):
    ...
    def closed(self, reason):
        ...
        writer.to_csv('result/scraping/scrapped_news.csv',
                      index=False, sep=',')        
